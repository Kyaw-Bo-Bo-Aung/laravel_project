...
<html lang="en">
  <head>
    ...
    <!-- Main CSS-->
    <link rel="stylesheet" type="text/css" href="{{asset("access/css/main.css")}}">
    <!-- Font-icon css-->
  ...
  <body class="app sidebar-mini">
    ...
    <script src="{{asset("access/js/jquery-3.3.1.min.js")}}"></script>
    <script src="{{asset("access/js/popper.min.js")}}"></script>
    <script src="{{asset("access/js/bootstrap.min.js")}}"></script>
    <script src="{{asset("access/js/main.js")}}"></script>
    <!-- The javascript plugin to display page loading on top-->
    <script src="{{asset("access/js/plugins/pace.min.js")}}"></script>
    <!-- Data table plugin-->
    <script type="text/javascript" src="{{asset("access/js/plugins/jquery.dataTables.min.js")}}"></script>
    <script type="text/javascript" src="{{asset("access/js/plugins/dataTables.bootstrap.min.js")}}"></script>
    <script type="text/javascript">$('#sampleTable').DataTable();</script>
    <!-- Page specific javascripts-->
    <script type="text/javascript" src="{{asset("access/js/plugins/chart.js")}}"></script>
